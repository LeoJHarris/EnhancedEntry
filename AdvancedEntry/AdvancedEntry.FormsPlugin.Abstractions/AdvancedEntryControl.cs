...
namespace AdvancedEntry.FormsPlugin.Abstractions
{
    ...
    /// </summary>
    public class AdvancedEntryControl : Entry
    {
        public event EventHandler EventTriggered;

        public static readonly BindableProperty ReturnTypeProperty = BindableProperty.Create(nameof(ReturnKeyType), typeof(ReturnKeyTypes), typeof(AdvancedEntryControl), ReturnKeyTypes.Done);

        public const string ReturnKeyPropertyName = "ReturnKeyType";

        public static readonly BindableProperty LeftIconProperty = BindableProperty.Create(nameof(LeftIconPropertyName), typeof(string), typeof(AdvancedEntryControl), string.Empty);
        ...
        public static readonly BindableProperty BorderColorProperty = BindableProperty.Create(nameof(BorderColorPropertyName), typeof(Color), typeof(AdvancedEntryControl), Color.Transparent);
        ...
        public static readonly BindableProperty BackgroundColorProperty = BindableProperty.Create(nameof(BackgroundColorPropertyName), typeof(Color), typeof(AdvancedEntryControl), Color.Transparent);
        ...
        public AdvancedEntryControl()
        {
            EventTriggered += Goto;
        }

        public AdvancedEntryControl Next { get; set; }
        ...
        {
            ((AdvancedEntryControl)sender)?.Next?.Focus();

            ((AdvancedEntryControl)sender)?.DoneCommand?.Execute(null);
        }
